...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = hdmi_in_axi_gpio_video
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.4
 PARAMETER HW_INSTANCE = hdmi_in_v_tc_in
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.4
 PARAMETER HW_INSTANCE = hdmi_out_v_tc_out
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcnet_get_dma_addr_axilite_regs_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcnet_io_axilite_regs_i2c_ir
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcnet_io_axilite_regs_spi
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcnet_io_axilite_regs_ir
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = hdmi_in_axilite_regs_hdmi_in_stat
END
...
BEGIN LIBRARY
 ...
 PARAMETER pbuf_pool_size = 32768
 PARAMETER tcp_snd_buf = 65535
 PARAMETER tcp_wnd = 65535
 PARAMETER udp_tx_blocking = true
END
