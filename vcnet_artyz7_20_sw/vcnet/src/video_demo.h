...
#define DEMO_MAX_FRAME (1920*1080*VCNET_BYTES_PER_PIXEL)
#define DEMO_STRIDE (1920 * VCNET_BYTES_PER_PIXEL)
...
void DemoInitialize();
void DemoRun();
void DemoRunNum(char userInput);
void DemoPrintMenu();
void DemoChangeRes();
void DemoChangeResNum(char userInput);
void DemoCRMenu();
