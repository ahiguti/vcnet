...
130: init_reg = 24'h6C_36_1A; // 6C 36 1A
131: init_reg = 24'h6C_37_36; // 6C 37 36
132: init_reg = 24'h6C_38_80; // 6C 38 80
133: init_reg = 24'h6C_39_A0; // 6C 39 A0
134: init_reg = 24'h6C_3A_70; // 6C 3A 70
135: init_reg = 24'h6C_3B_38; // 6C 3B 38
136: init_reg = 24'h6C_3C_1F; // 6C 3C 1F
137: init_reg = 24'h6C_3D_40; // 6C 3D 40
138: init_reg = 24'h6C_3E_30; // 6C 3E 30
139: init_reg = 24'h6C_3F_20; // 6C 3F 20
140: init_reg = 24'h6C_40_35; // 6C 40 35
141: init_reg = 24'h6C_41_00; // 6C 41 00
142: init_reg = 24'h6C_42_FE; // 6C 42 FE
143: init_reg = 24'h6C_43_1F; // 6C 43 1F
...
203: init_reg = 24'h6C_7F_1A; // 6C 7F 1A
