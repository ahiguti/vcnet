...
module aesenc(
    ...
    output [127:0] DEBUG_SUBST,
    output [127:0] DEBUG_SHIFTROWS
);
...
wire [127:0] sr = shift_rows(subst_r2);

assign DEBUG_SHIFTROWS = sr;
...
reg [127:0] mc_r1, mc_r2;

always @(posedge CLK) begin
    mc_r1 <= mix_columns(sr);
    mc_r2 <= mc_r1;
end

assign OUT_DATA = mc_r2;
