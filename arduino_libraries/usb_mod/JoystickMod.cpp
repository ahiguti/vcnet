...
void JoystickMod_::begin(bool initAutoSendState)
{
	_autoSendState = initAutoSendState;
	sendState();
}

void JoystickMod_::end()
{
}

void JoystickMod_::setButton(uint8_t button, uint8_t value)
{
	if (value == 0)
	{
...
void JoystickMod_::pressButton(uint8_t button)
{
...
void JoystickMod_::releaseButton(uint8_t button)
{
    if (button >= _buttonCount) return;
...
void JoystickMod_::setXAxis(int16_t value)
{
	_xAxis = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setYAxis(int16_t value)
{
	_yAxis = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setZAxis(int16_t value)
{
	_zAxis = value;
	if (_autoSendState) sendState();
}

void JoystickMod_::setRxAxis(int16_t value)
{
	_xAxisRotation = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setRyAxis(int16_t value)
{
	_yAxisRotation = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setRzAxis(int16_t value)
{
	_zAxisRotation = value;
	if (_autoSendState) sendState();
}

void JoystickMod_::setRudder(int16_t value)
{
	_rudder = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setThrottle(int16_t value)
{
	_throttle = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setAccelerator(int16_t value)
{
	_accelerator = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setBrake(int16_t value)
{
	_brake = value;
	if (_autoSendState) sendState();
}
void JoystickMod_::setSteering(int16_t value)
{
	_steering = value;
	if (_autoSendState) sendState();
}

void JoystickMod_::setHatSwitch(int8_t hatSwitchIndex, int16_t value)
{
...
int JoystickMod_::buildAndSet16BitValue(bool includeValue, int16_t value, int16_t valueMinimum, int16_t valueMaximum, int16_t actualMinimum, int16_t actualMaximum, uint8_t dataLocation[]) 
{
...
int JoystickMod_::buildAndSetAxisValue(bool includeAxis, int16_t axisValue, int16_t axisMinimum, int16_t axisMaximum, uint8_t dataLocation[]) 
{
...
int JoystickMod_::buildAndSetSimulationValue(bool includeValue, int16_t value, int16_t valueMinimum, int16_t valueMaximum, uint8_t dataLocation[]) 
{
